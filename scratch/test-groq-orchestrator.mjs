...
<user_raw_input>
i want to make an profil/ portfolio page
</user_raw_input>
...
<history_context>
User previously asked to make a portfolio page. You asked for clarification.
</history_context>
...
async function testGroq() {
  console.log('Testing Groq with Orchestrator Prompt...');
  try {
    ...
    const result = await generateText({
      model: openai(process.env.DEFAULT_LLM_MODEL || 'llama-3.3-70b-versatile'),
