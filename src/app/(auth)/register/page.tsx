    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0a0a0a] text-green-500 font-mono px-4 selection:bg-green-500/30">
      ...
      <div className="max-w-md w-full bg-[#111] border border-green-500/20 rounded-sm shadow-[0_0_30px_rgba(34,197,94,0.05)] p-8">
        <div className="text-center mb-8 border-b border-green-500/20 pb-6">
          <h1 className="text-2xl font-bold tracking-tight text-white mb-2">&gt; INIT_NEW_USER</h1>
          <p className="text-gray-400 text-sm">Create credentials to access the AI orchestrator</p>
        </div>
        ...
        <form onSubmit={handleRegister} className="space-y-5">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              minLength={6}
            />
            <p className="text-xs text-gray-500 mt-1">Status: Minimum 6 characters required</p>
          </div>
          ...
          >
            {loading ? '[ EXECUTING... ]' : './REGISTER.sh'}
          </button>
        </form>
        
        <p className="text-center text-sm text-gray-500 mt-8 pt-6 border-t border-green-500/20">
          Already have an account?{' '}
          <Link href="/login" className="text-green-500 hover:text-green-400 hover:underline underline-offset-4 transition-colors">
            [ Login_Here ]
          </Link>
        </p>
      </div>
